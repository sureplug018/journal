...
//   jQuery('.plus-author').on('click', function (e) {
//     e.preventDefault();
...
// 		  <div class="form-group sj-inputwithicon sj-password">
// 			<a style="cursor: pointer;" class="minus-author"><i style="font-size: 20px; color: #6E3F29;" class="lnr lnr-trash"></i></a>
// 		  </div>
// 		</div>
// 	  </div>`;

//     // Append the new author section right before the button
//     jQuery(this).closest('.author-section').after(newAuthorSection);
//   });

//   jQuery('.minus-author').on('click', function (e) {
//     e.preventDefault();
//     console.log('hello');
//     jQuery(this).closest('.author-section').remove();
//   });
});
